...
typedef enum
{
    ...
    CRSF_ADDRESS_CRSF_RECEIVER = 0xEC, //rec
...
typedef struct rcPacket_s
{
    ...
    struct crsf_channels_s channels;
} __attribute__((packed)) rcPacket_t;
...
} __attribute__((packed)) deviceInformationPacket_t;
...
} __attribute__((packed)) crsf_sensor_battery_s;
